...
<td class="pls pls_relative" rowspan="2"><!--{if $post['first']}-->
    ...
    <i class="arr"></i>
		<div class="pi <!--{if $post['first']}-->tpi<!--{/if}-->"<!--{if $close_leftinfo || (!$post['first'] && !$post['anonymous'] && $postshowavatars && $showavatars)}--> style="height:30px"<!--{/if}-->>
			<!--{if !IS_ROBOT}-->
			...
			<div class="pti">
               ...
               <span class="ico_see">$_G[forum_thread][views]</span><span class="ico_reply">$_G[forum_thread][allreplies]</span>
				...
				<!--{if $close_leftinfo || (!$post['first'] && !$post['anonymous'] && $postshowavatars && $showavatars)}-->
				...
				<!--{if $post['authorid'] && !$post['anonymous']}-->
					...
					<em id="authorposton$post[pid]"><a href="home.php?mod=space&uid=$post['authorid']" target="_blank" {if $post[groupcolor]} style="color: $post[groupcolor]"{/if}>$post[author]</a> {lang poston} $post[dateline]</em>
