          ...
          <div id="sd_bdr">
            <div class="view-bar">
              ...
              <dl class="view-bar-hd">
                <dt class="view-bar-img"> <a href="forum.php?mod=forumdisplay&fid=$_G[fid]"> 
                  <!--{if $_G['forum'][icon]}--> 
                ...
                <dd>
                  ...
                  <p><!--{if rssforumperm($_G['forum']) && $_G[setting][rssstatus] && !$_GET['archiveid'] && !$subforumonly}--><a href="forum.php?mod=rss&fid=$_G[fid]&auth=$rssauth" class="fa_rss" target="_blank" title="RSS">{lang rss_subscribe_this}</a><span class="pipe">|</span><!--{/if}--><a href="home.php?mod=spacecp&ac=favorite&type=forum&id=$_G[fid]&handlekey=favoriteforum" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);">关注 <em class="xi1" id="number_favorite" {if !$_G[forum][favtimes]} style="display:none;"{/if}>(<span id="number_favorite_num">$_G[forum][favtimes]</span>)</em></a></p>
                </dd>
              </dl>
              <div class="view-rule">
                ...
                <!--{if $moderatedby}-->
                <p class="view-moderator"> <span>{lang forum_modedby}：</span> $moderatedby </p>
                <!--{/if}--> 
              </div>
            </div>
...
<!--{if $allowpostreply && !$_G['forum_thread']['archiveid']}-->
			<a class="side_reply" id="side_reply" style="display:none" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]')" href="javascript:;" title="{lang reply}"><img src="$_G['style'][styleimgdir]/side_reply.png" width="28px" height="66px" alt="{lang reply}" /></a>
		<!--{/if}-->
<div class="cl">
	...
	<table cellspacing="0" cellpadding="0"> <!-- 开始 -->
		<tr>
            ...
            <div id="pt" class="bm cl">
                <div class="z"> <a href="./" class="nvhm" title="{lang homepage}">$_G[setting][bbname]</a><em>&raquo;</em><a href="forum.php">{$_G[setting][navs][2][navname]}</a>$navigation <em>&rsaquo;</em> <a href="forum.php?mod=viewthread&tid=$_G[tid]">查看内容</a> </div>
                <!--{if !IS_ROBOT}-->
					<div class="y">
