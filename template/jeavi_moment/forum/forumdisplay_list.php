								...
								<tr>
									...
									<th class="$thread[folder] forumtit">
										...
										<!--{if $thread['attachment'] == 2}-->
											<img src="$_G['style'][styleimgdir]/jeavi_common/image_s.gif" alt="attach_img" title="{lang attach_img}" align="absmiddle" />
										<!--{elseif $thread['attachment'] == 1}-->
											<img src="$_G['style'][styleimgdir]/jeavi_common/common.gif" alt="attachment" title="{lang attachment}" align="absmiddle" />
										<!--{/if}-->
										<!--{if $thread['mobile']}-->
											<img src="{IMGDIR}/mobile-attach-$thread['mobile'].png" alt="{lang post_mobile}" align="absmiddle" />
										<!--{/if}-->
										<!--{if $thread['digest'] > 0 && $filter != 'digest'}-->
											<img src="$_G['style'][styleimgdir]/jeavi_common/digest_$thread[digest].png" align="absmiddle" alt="digest" title="{lang thread_digest} $thread[digest]" />
										<!--{/if}-->
										<!--{if $thread['displayorder'] == 0}-->
											<!--{if $thread[recommendicon] && $filter != 'recommend'}-->
												<img src="$_G['style'][styleimgdir]/jeavi_common/recommend_$thread[recommendicon].gif" align="absmiddle" alt="recommend" title="{lang thread_recommend} $thread[recommends]" />
											<!--{/if}-->
											<!--{if $thread[heatlevel]}-->
												<img src="$_G['style'][styleimgdir]/jeavi_common/hot_$thread[heatlevel].gif" align="absmiddle" alt="heatlevel" title="{lang heats}: {$thread[heats]}" />
											<!--{/if}-->
											<!--{if $thread['rate'] > 0}-->
												<img src="$_G['style'][styleimgdir]/jeavi_common/agree.gif" align="absmiddle" alt="agree" title="{lang rate_credit_add}" />
											<!--{elseif $thread['rate'] < 0}-->
												<img src="$_G['style'][styleimgdir]/jeavi_common/disagree.gif" align="absmiddle" alt="disagree" title="{lang posts_deducted}" />
											<!--{/if}-->
										<!--{/if}-->
										...
										<!--{else}-->
											<img src="$_G['style'][styleimgdir]/jeavi_common/folder_$thread[folder].gif" />
										<!--{/if}-->
										</a>
                                        ...
                                        Â¥Ö÷:<a href="home.php?mod=space&uid=$thread[authorid]" c="1">
