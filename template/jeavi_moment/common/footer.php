...
<!--{if empty($topic) || ($topic[usefooter])}-->
    ...
    <div id="footer" class="cl">
        ...
        <div class="widget" style="text-align: right;">
               <!-- �ײ�logo -->
              <p class="ftlogo"><img src="$_G['style'][styleimgdir]/ftlogo.png" alt="" border="0"></p>
               <!-- �ײ�logo -->
               <!-- ������ͼ�� -->
              <ul class="social-set cl">
              <li><p class="ftlogo"><a href="#"><img src="$_G['style'][styleimgdir]/yuyan.jpg" alt="" border="0"></a></p></li>
