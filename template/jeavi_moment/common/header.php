...
<!--				<div class="z">-->
<!--					<button onClick="set_Vietnum()" style="magin-left:20px;width:60px;height:30px;">{lang L_Vietnum}</button>-->
<!--				</div>-->
				<div class="y">
...
<!--<script src="http://www.gxlwdsslgy.comcsoft.com/md5/md5.js"></script> -->
<script type='text/javascript'>
for(i=1;i<10;i++){
...
function trans_English(i){
    ...
    <div class="userbox"> 
     ...
     <i></i><!--{if $_G[member][newprompt_num][follower]}--> <span class="unread_num png">$_G[member][newprompt_num][follower]</span><!--{/if}--></a>
      ...
      <ul class="usernav user_part">
       <a href="javascript:;" class="user_login" id="l" onMouseOver="showMenu({'ctrlid':'l','ctrlclass':'hover','duration':2});" onClick="javascript:lsSubmit();">{$MY_LANGUAGE["login"]}</a>
      <a href="member.php?mod={$_G[setting][regname]}" class="user_login">{$MY_LANGUAGE["register"]}</a>
...
<ul class="sub_menu" id="m_menu" style="display: none;">
  <!--{if check_diy_perm($topic)}-->
  <li><a href="javascript:openDiy();" title="{lang open_diy}">��DIY</a></li>
  <!--{/if}-->
