...
<!--js脚本引入-->
<script src="{$_G['config']['wx']['domain']}\template\jeavi_moment\common\js\jquery.js" type="text/javascript"></script>
<script src="{$_G['config']['wx']['domain']}\template\jeavi_moment\common\js\jquery.cookie.js" type="text/javascript"></script>
...
function set_nav(){
		if(getCookie('language')=='China'){
			var menu_style="<style>li{list-style:none}</style>"
			var menu="<li ><a href='#' class='a'>{lang Menu_portal}</a><span>{lang Menu_portal_English}</span></li><li ><a href='http://localhost/portal.php?mod=list&catid=1' class='a'>{lang Menu_view}</a></li><li ><a href='http://localhost/portal.php?mod=view&aid=11' class='a'>{lang Menu_activities}</a></li><li ><a href='http://localhost/portal.php?mod=list&catid=4' class='a'>{lang Menu_raiders}</a></li><li ><a href='http://localhost/portal.php?mod=topic&topicid=2' class='a'>{lang Menu_tourism}</a></li>";
			var target = document.getElementById('nav_menu');
			target.innerHTML=menu_style+menu;
		}
		if(getCookie('language')=='English'){
			
			var menu_style="<style>li{list-style:none}</style>"
			var menu="<li ><a href='#' class='a'>{lang Menu_portal_English}</a><span>{lang Menu_portal_English}</span></li><li ><a href='http://localhost/portal.php?mod=list&catid=1' class='a'>{lang Menu_view_English}</a></li><li ><a href='http://localhost/portal.php?mod=view&aid=11' class='a'>{lang Menu_activities_English}</a></li><li ><a href='http://localhost/portal.php?mod=list&catid=4' class='a'>{lang Menu_raiders_English}</a></li><li ><a href='http://localhost/portal.php?mod=topic&topicid=2' class='a'>{lang Menu_tourism_English}</a></li>";
			var target = document.getElementById('nav_menu');
			target.innerHTML=menu_style+menu;
		}
		if(getCookie('language')=='Japan'){
			
			var menu_style="<style>li{list-style:none}</style>"
			var menu="<li ><a href='#' class='a'>{lang Menu_portal_Japan}</a><span>{lang Menu_portal_English}</span></li><li ><a href='http://localhost/portal.php?mod=list&catid=1' class='a'>{lang Menu_view_Japan}</a></li><li ><a href='http://localhost/portal.php?mod=view&aid=11' class='a'>{lang Menu_activities_Japan}</a></li><li ><a href='http://localhost/portal.php?mod=list&catid=4' class='a'>{lang Menu_raiders_Japan}</a></li><li ><a href='http://localhost/portal.php?mod=topic&topicid=2' class='a'>{lang Menu_tourism_Japan}</a></li>";
			var target = document.getElementById('nav_menu');
			target.innerHTML=menu_style+menu;
		}
		if(getCookie('language')=='Korea'){
			
			var menu_style="<style>li{list-style:none}</style>"
			var menu="<li ><a href='#' class='a'>{lang Menu_portal_Korea}</a><span>{lang Menu_portal_English}</span></li><li ><a href='http://localhost/portal.php?mod=list&catid=1' class='a'>{lang Menu_view_Korea}</a></li><li ><a href='http://localhost/portal.php?mod=view&aid=11' class='a'>{lang Menu_activities_Korea}</a></li><li ><a href='http://localhost/portal.php?mod=list&catid=4' class='a'>{lang Menu_raiders_Korea}</a></li><li ><a href='http://localhost/portal.php?mod=topic&topicid=2' class='a'>{lang Menu_tourism_Korea}</a></li>";
			var target = document.getElementById('nav_menu');
			target.innerHTML=menu_style+menu;
		}
		if(getCookie('language')=='Melayu'){
			
			var menu_style="<style>li{list-style:none}</style>"
			var menu="<li ><a href='#' class='a'>{lang Menu_portal_Melayu}</a><span>{lang Menu_portal_English}</span></li><li ><a href='http://localhost/portal.php?mod=list&catid=1' class='a'>{lang Menu_view_Melayu}</a></li><li ><a href='http://localhost/portal.php?mod=view&aid=11' class='a'>{lang Menu_activities_Melayu}</a></li><li ><a href='#' class='a'>{lang Menu_raiders_Melayu}</a></li><li ><a href='http://localhost/portal.php?mod=topic&topicid=2' class='a'>{lang Menu_tourism_Melayu}</a></li>";
			var target = document.getElementById('nav_menu');
			target.innerHTML=menu_style+menu;
		}
}
	...
	function set_Korea(){
		setCookie('language','Korea');
	location.reload();		
	}

	function set_Melayu(){
		setCookie('language','Melayu');
		location.reload();
	}
...
<div id="toptb" class="cl">
			...
			<div class="wp">
				...
				<!--语言选择-->
				<div class="z">
					<button onclick="set_China()" style="magin-left:20px;width:60px;height:30px;">{lang L_China}</button>
				</div>
				<div class="z">
					<button onclick="set_English()" style="magin-left:20px;width:60px;height:30px;">{lang L_English}</button>
				</div>
				<div class="z">
					<button onclick="set_Japan()" style="magin-left:20px;width:60px;height:30px;">{lang L_Japan}</button>
				</div>
				<div class="z">
					<button onClick="set_Korea()" style="magin-left:20px;width:60px;height:30px;">{lang L_Korean}</button>
				</div>
				<div class="z">
					<button onClick="set_Melayu()" style="magin-left:20px;width:60px;height:30px;">{lang L_Melayu}</button>
				</div>
				<div class="z">
					<button onClick="che()" style="magin-left:20px;width:60px;height:30px;">{lang L_Melayu}</button>
				</div>
				<!--语言选择结尾-->
...
<div class="header"> 
  ...
  <div class="wp cl"> 
    ...
    <div class="nav" id="nav_menu">
		...
		<li ><a id='menu_1' href='#' class='a'>{lang Menu_portal}</a><span>{lang Menu_portal_English}</span></li>
		<li ><a href='#' class='a'>{lang Menu_view}</a></li>
		<li ><a href='#' class='a'>{lang Menu_activities}</a></li>
		<li ><a href='#' class='a'>{lang Menu_raiders}</a></li>
		<li ><a href='#' class='a'>{lang Menu_tourism}</a></li>
		</ul>
	</div>
    ...
    <div class="userbox"> 
     ...
     <i></i><!--{if $_G[member][newprompt_num][follower]}--> <span class="unread_num png">$_G[member][newprompt_num][follower]</span><!--{/if}--></a>
      </li>
      ...
      <a href="home.php?mod=space&uid=$_G[uid]&do=profile" title="{$_G[member][username]}" class="userinfo" id="m" onMouseOver="showMenu({'ctrlid':'m','pos':'34!','ctrlclass':'hover','duration':2});"> <span class="user_avt"><!--{avatar($_G[uid],small)}--></span></a> 
      ...
      <a href="member.php?mod={$_G[setting][regname]}" class="user_login">$_G['setting']['reglinkname']</a>
...
<ul id="myprompt_menu" class="p_pop" style="display: none;">
  ...
  <li class="ignore_noticeli"><a href="javascript:;" onClick="$.cookie('ignore_notice', 1);hideMenu('myprompt_menu')" title="{lang temporarily_to_remind}"><em class="ignore_notice"></em></a></li>
  <!--{/if}-->
</ul>
<!--{/if}--> 
