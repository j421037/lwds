...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1562297570, '2', './data/template/2_2_common_header_group_index.tpl.php', './template/jeavi_moment', 'common/header_group_index')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1562297570, '2', './data/template/2_2_common_header_group_index.tpl.php', './template/jeavi_moment', 'common/header_group_index')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1562297570, '2', './data/template/2_2_common_header_group_index.tpl.php', './template/jeavi_moment', 'common/header_group_index')
;?>
