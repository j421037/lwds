...
0
|| checktplrefresh('./template/moke8_doormobile/touch/member/login.htm', './template/default/touch/common/seccheck.htm', 1564230576, '4', './data/template/4_4_touch_member_login.tpl.php', './template/moke8_doormobile', 'touch/member/login')
...
<li class="btn_qqlogin"><a href="<?php echo $_G['connect']['login_url'];?>&statfrom=login_simple">!connect_mobile_login!</a></li>
<?php } ?>
