...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1563935704, '2', './data/template/2_2_common_header_portal_view.tpl.php', './template/jeavi_moment', 'common/header_portal_view')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1563935704, '2', './data/template/2_2_common_header_portal_view.tpl.php', './template/jeavi_moment', 'common/header_portal_view')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1563935704, '2', './data/template/2_2_common_header_portal_view.tpl.php', './template/jeavi_moment', 'common/header_portal_view')
;?>
