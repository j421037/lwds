...
0
|| checktplrefresh('./template/default/portal/view.htm', './template/jeavi_moment/portal/portal_comment.htm', 1562213668, 'diy', './data/template/2_diy_portal_view.tpl.php', './template/jeavi_moment', 'portal/view')
|| checktplrefresh('./template/default/portal/view.htm', './template/default/common/seccheck.htm', 1562213668, 'diy', './data/template/2_diy_portal_view.tpl.php', './template/jeavi_moment', 'portal/view')
