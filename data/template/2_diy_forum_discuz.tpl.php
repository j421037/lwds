...
slideImgTexts[<?php echo $k; ?>] = '<?php echo $svalue['subject'];?>';<?php $k++;?><?php } ?>
  ...
  <div id="sd" class="sd"> 
    ...
    <div id="slideBox" class="slideBox cl"> 
      <!--[diy=j_1]--><div id="j_1" class="area"><div id="frame8JgO5p" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">��Ա����</span></div><div id="frame8JgO5p_left" class="column frame-1-c"><div id="frame8JgO5p_left_temp" class="move-span temp"></div><?php block_display('36');?></div></div></div><!--[/diy]--> 
    </div>
    <div class="hbody cl">
