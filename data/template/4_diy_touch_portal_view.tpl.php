...
0
|| checktplrefresh('./template/moke8_doormobile/touch/portal/view.htm', './template/moke8_doormobile/touch/portal/portal_comment.htm', 1587452266, 'diy', './data/template/4_diy_touch_portal_view.tpl.php', 'data/diy/./template/jeavi_moment/', 'touch/portal/view')
|| checktplrefresh('./template/moke8_doormobile/touch/portal/view.htm', './template/default/touch/common/seccheck.htm', 1587452266, 'diy', './data/template/4_diy_touch_portal_view.tpl.php', 'data/diy/./template/jeavi_moment/', 'touch/portal/view')
