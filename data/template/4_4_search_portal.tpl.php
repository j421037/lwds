...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1562563378, '4', './data/template/4_4_search_portal.tpl.php', './template/moke8_doormobile', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1562563378, '4', './data/template/4_4_search_portal.tpl.php', './template/moke8_doormobile', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1562563378, '4', './data/template/4_4_search_portal.tpl.php', './template/moke8_doormobile', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1562563378, '4', './data/template/4_4_search_portal.tpl.php', './template/moke8_doormobile', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/common/header_common.htm', 1562563378, '4', './data/template/4_4_search_portal.tpl.php', './template/moke8_doormobile', 'search/portal')
;?>
...
<tr>
<td><h1><a href="search.php" title="<?php echo $_G['setting']['bbname'];?>"><img src="<?php echo IMGDIR;?>/logo.png" alt="<?php echo $_G['setting']['bbname'];?>" /></a></h1></td>
<td>
