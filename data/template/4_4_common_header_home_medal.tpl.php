...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1589428585, '4', './data/template/4_4_common_header_home_medal.tpl.php', './template/moke8_doormobile', 'common/header_home_medal')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1589428585, '4', './data/template/4_4_common_header_home_medal.tpl.php', './template/moke8_doormobile', 'common/header_home_medal')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1589428585, '4', './data/template/4_4_common_header_home_medal.tpl.php', './template/moke8_doormobile', 'common/header_home_medal')
;?>
