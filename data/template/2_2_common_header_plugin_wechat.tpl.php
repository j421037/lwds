...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1563934670, '2', './data/template/2_2_common_header_plugin_wechat.tpl.php', './template/jeavi_moment', 'common/header_plugin_wechat')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1563934670, '2', './data/template/2_2_common_header_plugin_wechat.tpl.php', './template/jeavi_moment', 'common/header_plugin_wechat')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1563934670, '2', './data/template/2_2_common_header_plugin_wechat.tpl.php', './template/jeavi_moment', 'common/header_plugin_wechat')
;?>
