...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1562334809, '4', './data/template/4_4_common_header_group_index.tpl.php', './template/moke8_doormobile', 'common/header_group_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1562334809, '4', './data/template/4_4_common_header_group_index.tpl.php', './template/moke8_doormobile', 'common/header_group_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1562334809, '4', './data/template/4_4_common_header_group_index.tpl.php', './template/moke8_doormobile', 'common/header_group_index')
;?>
