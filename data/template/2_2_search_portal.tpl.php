...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1564022861, '2', './data/template/2_2_search_portal.tpl.php', './template/jeavi_moment', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1564022861, '2', './data/template/2_2_search_portal.tpl.php', './template/jeavi_moment', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1564022861, '2', './data/template/2_2_search_portal.tpl.php', './template/jeavi_moment', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1564022861, '2', './data/template/2_2_search_portal.tpl.php', './template/jeavi_moment', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/jeavi_moment/common/header_common.htm', 1564022861, '2', './data/template/2_2_search_portal.tpl.php', './template/jeavi_moment', 'search/portal')
;?>
