...
0
|| checktplrefresh('./template/jeavi_moment/forum/forumdisplay.htm', './template/jeavi_moment/forum/forumdisplay_leftside.htm', 1562216284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/jeavi_moment', 'forum/forumdisplay')
|| checktplrefresh('./template/jeavi_moment/forum/forumdisplay.htm', './template/jeavi_moment/forum/recommend.htm', 1562216284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/jeavi_moment', 'forum/forumdisplay')
|| checktplrefresh('./template/jeavi_moment/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1562216284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/jeavi_moment', 'forum/forumdisplay')
|| checktplrefresh('./template/jeavi_moment/forum/forumdisplay.htm', './template/jeavi_moment/forum/forumdisplay_list.htm', 1562216284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/jeavi_moment', 'forum/forumdisplay')
|| checktplrefresh('./template/jeavi_moment/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1562216284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/jeavi_moment', 'forum/forumdisplay')
|| checktplrefresh('./template/jeavi_moment/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1562216284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/jeavi_moment', 'forum/forumdisplay')
|| checktplrefresh('./template/jeavi_moment/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1562216284, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/jeavi_moment', 'forum/forumdisplay')
...
<!--[/diy]--> <?php echo adshow("text/wp a_t");?><div class="wp"> 
  <!--[diy=diy1]-->
...
.waterfall {margin-left: 10px;}
    ...
    <!-- ����鵼�� -->
    <div id="sd_bdl" class="bdl" onmouseover="showMenu({'ctrlid':this.id, 'pos':'dz'});" style="width:140px;"> 
...
<?php } ?> 
  ...
  <div id="ct" class="wp cl" <?php if($leftside) { ?> style="margin-left:180px"<?php } ?>> 
  ...
  <div class="display-r">
    <div id="sd_bdr">
      <div class="forum-bar">
        <dl class="forum-bar-hd">
          <dt class="forum-bar-img"> <a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>"> 
        ...
        <div class="forum-rule">
          <div class="forum-desc"> <i class="desc-l"></i> 
          ...
          <?php if($moderatedby) { ?>
          <p class="forum-moderator"> <span>版主��</span> <?php echo $moderatedby;?> </p>
          <?php } ?> 
        </div>
        
        <?php if(!$subforumonly) { ?>
        <div class="forum-bar-info"> <span><b><?php echo $_G['forum']['todayposts'];?></b><strong>今日</strong></span> <span class="bni"><b><?php echo $_G['forum']['threads'];?></b><strong>主题</strong></span> </div>
        <?php } ?> 
      </div>
...
getnewlivepostlist();
      ...
      <?php if(empty($_G['forum']['threadtypes']) || empty($_G['forum']['threadtypes']['listable'])) { ?>
      <span id="fd_page_top"><?php echo $multipage;?></span> <span class="pgb y" <?php if($_G['setting']['visitedforums']) { ?>id="visitedforums" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id,'pos':'34'})"<?php } ?> ><a href="forum.php">返&nbsp;回</a></span> 

      
        <?php } ?>    
            <div class="npgs <?php if(empty($_G['forum']['threadtypes']) || empty($_G['forum']['threadtypes']['listable'])) { ?>z mb10<?php } else { ?> y ml20 <?php } ?>">
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/image_s.gif" alt="attach_img" title="图片附件" align="absmiddle" />
<?php } elseif($thread['attachment'] == 1) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/common.gif" alt="attachment" title="附件" align="absmiddle" />
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/digest_<?php echo $thread['digest'];?>.png" align="absmiddle" alt="digest" title="精华 <?php echo $thread['digest'];?>" />
<?php } if($thread['displayorder'] == 0) { if($thread['recommendicon'] && $filter != 'recommend') { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/recommend_<?php echo $thread['recommendicon'];?>.gif" align="absmiddle" alt="recommend" title="评价指数 <?php echo $thread['recommends'];?>" />
<?php } if($thread['heatlevel']) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/hot_<?php echo $thread['heatlevel'];?>.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
<?php } if($thread['rate'] > 0) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/agree.gif" align="absmiddle" alt="agree" title="帖子被加分" />
<?php } elseif($thread['rate'] < 0) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/disagree.gif" align="absmiddle" alt="disagree" title="帖子被减分" />
...
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/folder_lock.gif" />
<?php } elseif($thread['special'] == 1) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/pollsmall.gif" alt="投票" />
<?php } elseif($thread['special'] == 2) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/tradesmall.gif" alt="商品" />
<?php } elseif($thread['special'] == 3) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/rewardsmall.gif" alt="悬赏" />
<?php } elseif($thread['special'] == 4) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/activitysmall.gif" alt="活动" />
<?php } elseif($thread['special'] == 5) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/debatesmall.gif" alt="辩论" />
<?php } elseif(in_array($thread['displayorder'], array(1, 2, 3, 4))) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/pin_<?php echo $thread['displayorder'];?>.gif" alt="<?php echo $_G['setting']['threadsticky'][3-$thread['displayorder']];?>" />
<?php } else { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/jeavi_common/folder_<?php echo $thread['folder'];?>.gif" />
<?php } ?>
</a>
