...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1587444061, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/jeavi_moment', 'common/header_home_space')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1587444061, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/jeavi_moment', 'common/header_home_space')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1587444061, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/jeavi_moment', 'common/header_home_space')
;?>
