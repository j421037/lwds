...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1562208618, '2', './data/template/2_2_common_header_portal_list.tpl.php', './template/jeavi_moment', 'common/header_portal_list')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1562208618, '2', './data/template/2_2_common_header_portal_list.tpl.php', './template/jeavi_moment', 'common/header_portal_list')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1562208618, '2', './data/template/2_2_common_header_portal_list.tpl.php', './template/jeavi_moment', 'common/header_portal_list')
;?>
