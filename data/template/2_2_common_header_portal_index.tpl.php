...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1587440971, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/jeavi_moment', 'common/header_portal_index')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1587440971, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/jeavi_moment', 'common/header_portal_index')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1587440971, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/jeavi_moment', 'common/header_portal_index')
;?>
