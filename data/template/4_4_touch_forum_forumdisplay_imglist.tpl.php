...
<span class="threadType">鎶曠エ</span>
<?php } elseif($thread['special'] == 2) { ?>
<span class="threadType">鍟嗗搧</span>
<?php } elseif($thread['special'] == 3) { ?>
<span class="threadType">鎮祻</span>
<?php } elseif($thread['special'] == 4) { ?>
<span class="threadType">娲诲姩</span>
<?php } elseif($thread['special'] == 5) { ?>
<span class="threadType">杈╄</span>
...
<?php } } else { ?>
<li class="noData">鏈増鍧楁垨鎸囧畾鐨勮寖鍥村唴灏氭棤涓婚</li>
<?php } ?>
</ul>
</div>
<?php echo $multipage;?>
...
<script src="template/moke8_doormobile/touch/images/js/jquery.masonry.min.js" type="text/javascript"></script>
