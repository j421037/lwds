...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1564025146, '2', './data/template/2_2_common_header_misc_mobile.tpl.php', './template/jeavi_moment', 'common/header_misc_mobile')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1564025146, '2', './data/template/2_2_common_header_misc_mobile.tpl.php', './template/jeavi_moment', 'common/header_misc_mobile')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1564025146, '2', './data/template/2_2_common_header_misc_mobile.tpl.php', './template/jeavi_moment', 'common/header_misc_mobile')
;?>
