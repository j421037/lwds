...
<title><?php if(!empty($navtitle)) { ?><?php echo $navtitle;?> - <?php } if(empty($nobbname)) { ?> <?php echo $_G['setting']['bbname'];?> - <?php } ?> 鎵嬫満鐗� - Powered by Discuz!</title><?php require_once(DISCUZ_ROOT.'/template/moke8_doormobile/touch/php/config.php');?><?php require_once(DISCUZ_ROOT.'/template/moke8_doormobile/touch/php/func.php');?><script src="<?php echo STATICURL;?>js/mobile/jquery-1.8.3.min.js?<?php echo VERHASH;?>" type="text/javascript"></script>
