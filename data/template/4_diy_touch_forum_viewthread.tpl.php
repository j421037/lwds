...
0
|| checktplrefresh('./template/moke8_doormobile/touch/forum/viewthread.htm', './template/moke8_doormobile/touch/forum/forumdisplay_fastpost.htm', 1563955649, 'diy', './data/template/4_diy_touch_forum_viewthread.tpl.php', './template/moke8_doormobile', 'touch/forum/viewthread')
|| checktplrefresh('./template/moke8_doormobile/touch/forum/viewthread.htm', './template/default/touch/common/seccheck.htm', 1563955649, 'diy', './data/template/4_diy_touch_forum_viewthread.tpl.php', './template/moke8_doormobile', 'touch/forum/viewthread')
;?>
<?php $threadsort = $threadsorts = null;?><?php include template('common/header'); ?><!-- header start -->
<header class="header">
<a class="topShare fr" href="#viewShare">����</a>
<a class="goBack fl" href="<?php if($_GET['fromguid'] == 'hot') { ?>forum.php?mod=guide&view=hot&page=<?php echo $_GET['page'];?><?php } else { ?>forum.php?mod=forumdisplay&fid=<?php echo $_G['fid'];?>&<?php echo rawurldecode($_GET[extra]);?><?php } ?>">����</a>
...
<!--signature end-->
 ...
 <?php if($post['first']) { ?>
<h3 class="postListHd" id="reComments">�ظ�����</h3>
<?php } ?>
...
<a class="viewBtn Jq_viewBtn" href="javascript:void(0);">��ҲҪ˵����</a>
<table>
<tr>
<td>
...
<span class="inp z">��ҲҪ˵����</span>
<span class="btn1 y">�ظ�</span>
</a>
</div>
<script type="text/javascript">
(function() {
...
<div class="wxShare"><a class="jiathis_button_weixin" href="#">΢��</a></div>
