...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1587681742, '2', './data/template/2_2_common_header.tpl.php', './template/jeavi_moment', 'common/header')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1587681742, '2', './data/template/2_2_common_header.tpl.php', './template/jeavi_moment', 'common/header')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1587681742, '2', './data/template/2_2_common_header.tpl.php', './template/jeavi_moment', 'common/header')
;?>
