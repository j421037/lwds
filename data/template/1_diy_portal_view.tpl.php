...
0
|| checktplrefresh('data/diy/./template/jeavi_moment/portal/view_4.htm', './template/default/portal/portal_comment.htm', 1588232807, 'diy', './data/template/1_diy_portal_view.tpl.php', 'data/diy/./template/jeavi_moment/', 'portal/view')
|| checktplrefresh('data/diy/./template/jeavi_moment/portal/view_4.htm', './template/default/common/seccheck.htm', 1588232807, 'diy', './data/template/1_diy_portal_view.tpl.php', 'data/diy/./template/jeavi_moment/', 'portal/view')
