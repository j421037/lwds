...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1587456353, '4', './data/template/4_4_common_header_portal_topic.tpl.php', './template/moke8_doormobile', 'common/header_portal_topic')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1587456353, '4', './data/template/4_4_common_header_portal_topic.tpl.php', './template/moke8_doormobile', 'common/header_portal_topic')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1587456353, '4', './data/template/4_4_common_header_portal_topic.tpl.php', './template/moke8_doormobile', 'common/header_portal_topic')
;?>
