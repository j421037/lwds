...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1587667825, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/jeavi_moment', 'common/header_home_magic')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1587667825, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/jeavi_moment', 'common/header_home_magic')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1587667825, '2', './data/template/2_2_common_header_home_magic.tpl.php', './template/jeavi_moment', 'common/header_home_magic')
;?>
