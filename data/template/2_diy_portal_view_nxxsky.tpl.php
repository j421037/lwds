...
0
|| checktplrefresh('./template/jeavi_moment/portal/view_nxxsky.htm', './template/jeavi_moment/portal/portal_comment.htm', 1562208565, 'diy', './data/template/2_diy_portal_view_nxxsky.tpl.php', './template/jeavi_moment', 'portal/view_nxxsky')
|| checktplrefresh('./template/jeavi_moment/portal/view_nxxsky.htm', './template/default/common/seccheck.htm', 1562208565, 'diy', './data/template/2_diy_portal_view_nxxsky.tpl.php', './template/jeavi_moment', 'portal/view_nxxsky')
