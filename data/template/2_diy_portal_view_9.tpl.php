<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('view_9');
0
|| checktplrefresh('data/diy/./template/jeavi_moment//portal/view_9.htm', './template/jeavi_moment/portal/portal_comment.htm', 1563944965, 'diy', './data/template/2_diy_portal_view_9.tpl.php', 'data/diy/./template/jeavi_moment/', 'portal/view_9')
|| checktplrefresh('data/diy/./template/jeavi_moment//portal/view_9.htm', './template/default/common/seccheck.htm', 1563944965, 'diy', './data/template/2_diy_portal_view_9.tpl.php', 'data/diy/./template/jeavi_moment/', 'portal/view_9')
