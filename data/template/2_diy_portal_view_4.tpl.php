...
0
|| checktplrefresh('data/diy/./template/jeavi_moment//portal/view_4.htm', './template/jeavi_moment/portal/portal_comment.htm', 1563940406, 'diy', './data/template/2_diy_portal_view_4.tpl.php', 'data/diy/./template/jeavi_moment/', 'portal/view_4')
|| checktplrefresh('data/diy/./template/jeavi_moment//portal/view_4.htm', './template/default/common/seccheck.htm', 1563940406, 'diy', './data/template/2_diy_portal_view_4.tpl.php', 'data/diy/./template/jeavi_moment/', 'portal/view_4')
