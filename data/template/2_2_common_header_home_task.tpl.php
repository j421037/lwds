...
0
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/header_common.htm', 1562232746, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/jeavi_moment', 'common/header_home_task')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/jeavi_moment/common/pubsearchform.htm', 1562232746, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/jeavi_moment', 'common/header_home_task')
|| checktplrefresh('./template/jeavi_moment/common/header.htm', './template/default/common/header_qmenu.htm', 1562232746, '2', './data/template/2_2_common_header_home_task.tpl.php', './template/jeavi_moment', 'common/header_home_task')
;?>
