...
0
|| checktplrefresh('./template/jeavi_moment/forum/guide.htm', './template/jeavi_moment/forum/guide_list_row.htm', 1564259119, '2', './data/template/2_2_forum_guide.tpl.php', './template/jeavi_moment', 'forum/guide')
...
<?php echo $multipage;?>
<a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav"><img src="<?php echo $_G['style']['styleimgdir'];?>/pn_post.png" alt="发新帖" /></a>
</div>
<?php } ?>
...
<tr <?php $i++;?> <?php if(($i % 2 === 0)) { ?> <?php $i=0;?> class="list2"<?php } ?>>
<td class="icn">
