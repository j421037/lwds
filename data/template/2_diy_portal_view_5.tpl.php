...
0
|| checktplrefresh('data/diy/./template/jeavi_moment//portal/view_5.htm', './template/jeavi_moment/portal/portal_comment.htm', 1587453487, 'diy', './data/template/2_diy_portal_view_5.tpl.php', 'data/diy/./template/jeavi_moment/', 'portal/view_5')
|| checktplrefresh('data/diy/./template/jeavi_moment//portal/view_5.htm', './template/default/common/seccheck.htm', 1587453487, 'diy', './data/template/2_diy_portal_view_5.tpl.php', 'data/diy/./template/jeavi_moment/', 'portal/view_5')
