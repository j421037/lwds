...
<?php } ?><?php echo adshow("footerbanner/wp a_f/1");?><?php echo adshow("footerbanner/wp a_f/2");?><?php echo adshow("footerbanner/wp a_f/3");?><?php echo adshow("float/a_fl/1");?><?php echo adshow("float/a_fr/2");?><?php echo adshow("couplebanner/a_fl a_cb/1");?><?php echo adshow("couplebanner/a_fr a_cb/2");?><?php echo adshow("cornerbanner/a_cn");?><?php if(!empty($_G['setting']['pluginhooks']['global_footer'])) echo $_G['setting']['pluginhooks']['global_footer'];?>
    ...
    <div id="footer" class="cl">
        ...
        <div class="widget" style="text-align: right;">
               <!-- �ײ�logo -->
              <p class="ftlogo"><img src="<?php echo $_G['style']['styleimgdir'];?>/ftlogo.png" alt="" border="0"></p>
               <!-- �ײ�logo -->
               <!-- ������ͼ�� -->
              <ul class="social-set cl">
              <li><p class="ftlogo"><a href="#"><img src="<?php echo $_G['style']['styleimgdir'];?>/yuyan.jpg" alt="" border="0"></a></p></li>
...
<?php if($_G['setting']['statcode']) { ?><?php echo $_G['setting']['statcode'];?><?php } ?>
            ...
            <p>地址：广西玉林市成均镇六万大山森林公园 &nbsp;&nbsp;电话：0775-2259606、0775-2259629、0775-2259636</p>
...
<?php } ?>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/nav.js" type="text/javascript"></script><?php userappprompt();?><?php if($_G['basescript'] != 'userapp') { ?>
<div id="scrolltop">
