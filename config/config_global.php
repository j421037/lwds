...
$_config['db']['1']['dbname'] = 'lwds_utf8';
$_config['db']['1']['tablepre'] = 'pre_';
$_config['db']['slave'] = '';
$_config['db']['common']['slave_except_table'] = '';

// --------------------------  CONFIG MEMORY  --------------------------- //
$_config['memory']['prefix'] = '5yWMWw_';
...
$_config['memory']['memcache']['timeout'] = 0;
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'DJub_';
$_config['cookie']['cookiedomain'] = 'gxlwdsslgy.com';
//$_config["cookie"]["cookiedomain"] = "localhost";
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '110c3362yO0Fz90T';
